    ...
    <div className="mx-auto w-full max-w-6xl space-y-6">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-12 sm:p-16 text-center">
          ...
          <Link href="/printers/add" className="inline-flex items-center gap-2 mt-5 bg-slate-900 hover:bg-slate-800 text-white text-sm font-bold px-5 py-2.5 rounded-xl transition-colors">
