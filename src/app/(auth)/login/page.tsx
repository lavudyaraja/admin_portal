...
import { apiFetch, setToken, isConsoleRole, type AdminUser } from "@/lib/api";
import {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link href="/forgot-password" className="text-sm text-[#C4622D] font-semibold hover:underline">
              Forgot password?
            </Link>
          </div>
          <div className="relative">
        ...
        <label className="flex items-center gap-3 cursor-pointer select-none">
          <div
            ...
            className={`w-5 h-5 rounded-md border-2 flex items-center justify-center transition-all ${remember ? "bg-[#C4622D] border-[#C4622D]" : "border-stone-300 bg-white"}`}
          >
            {remember && (
